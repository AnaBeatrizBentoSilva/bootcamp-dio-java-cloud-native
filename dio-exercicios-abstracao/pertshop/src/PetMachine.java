public class PetMachine {
    ...
    public void addWater() {
        if(water == 30){
            System.out.println("A capacidade de água da máquina já está no máximo");
            return;
        }
        water += 2;
    }
    ...
    public void addShampoo() {
        if(shampoo == 10){
            System.out.println("A capacidade de shampoo da máquina já está no máximo");
            return;
        }
        shampoo += 2;
    }
    ...
    public void wash(){
        ...
        this.shampoo -= 2;
        this.clean = true;
        System.out.println("A máquina foi limpada");
    }
}
